%{
    ...
    const aritmetico = require('./models/Expresions/Arithmetic');
    const impresion = require('./models/Instructions/Print');   
    const { Production } = require('./models/Three/Production');
    const Three = require('./models/Three/Three')
    const tipo = require('./models/Symbol/Type');
    const errores = require('./models/Exception/Error')
    const errors = []
%}
%lex 
